...
class StockRepository:
    ...
    async def create_item(self, price: int) -> str:
        ...
        await self._run_redis_operation(
            "stock.create_item",
            lambda: self._redis.set(item_id, value),
        )
        return item_id
    ...
    async def get_item(self, item_id: str) -> StockValue:
        raw = await self._run_redis_operation(
            "stock.get_item",
            lambda: self._redis.get(item_id),
        )
        if raw is None:
    ...
    async def add_stock(self, item_id: str, amount: int) -> StockValue:
        async def operation() -> StockValue:
            while True:
                try:
        ...
        return await self._run_redis_operation("stock.add_stock", operation)
    ...
    async def subtract_stock(self, item_id: str, amount: int) -> StockValue:
        ...
        return await self._run_redis_operation("stock.subtract_stock", operation)
    ...
    async def reserve_stock_idempotent(
        ...
        *,
        ...
        async def operation() -> StockReservation:
            while True:
                try:
                    async with self._redis.pipeline(transaction=True) as pipe:
        ...
        return await self._run_redis_operation("stock.reserve_stock_idempotent", operation)
    ...
    async def reserve_stock_batch_idempotent(
        ...
        *,
        ...
        async def operation() -> tuple[StockReservation, ...]:
        ...
        return await self._run_redis_operation(
            "stock.reserve_stock_batch_idempotent",
            operation,
        )
    ...
    async def release_stock_idempotent(
        ...
        *,
        ...
        return await self._run_redis_operation("stock.release_stock_idempotent", operation)
    ...
    async def release_stock_batch_idempotent(
        ...
        *,
        ...
        return await self._run_redis_operation(
            "stock.release_stock_batch_idempotent",
            operation,
        )
